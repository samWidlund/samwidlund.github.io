...
export default function App() {
    return (
      <div className="min-h-screen flex flex-col justify-center font-mono text-base">
        <div className="absolute top-0 w-full flex p-2 justify-center text-white text-md bg-[rgba(30,30,30,0.85)] backdrop-blur-sm shadow-[0_1px_0_rgba(100,100,100,0.3)]">
